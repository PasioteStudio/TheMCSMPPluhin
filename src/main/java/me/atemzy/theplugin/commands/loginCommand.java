        ...
        if (commandSender instanceof Player){
            ...
            if(volt.equals("1")){
                ...
                if(strings.length >0){
                    ...
                    if(voltnote.getPsw().equals(stringBuilder.toString())){
                        ...
                        Note isInWorldnote = new Note(voltnote.getPlayerName(), voltnote.getPsw(), voltnote.getLastWorld(), voltnote.getLastX(), voltnote.getLastY(), voltnote.getLastZ(), true);
